...
\ifthenelse{\boolean{markup}}{ 
  \textcolor{\markcolor}{\begin{center}{\Large DRAFT AMENDMENT 006\\ MARKED-UP VERSION FOR REFERENCE}\end{center}} \vfill}{}
...
1.5 & Out for ratification, changes not included here &  &  \\ \hline
...
1.7 & Amendments to S2,3,6,7,10 to address minor inconsistencies and extend GB attendance requirements to account for extenuating circumstances & 08/03/2021 & \\ 
...
\textcolor{\markcolor}{Throughout this document, when referring to ``major bodies'', we intend: major body 1, major body 2, .., major body N. Those entities not explicitly mentioned in the former list are intended as ``minor bodies''. Note that this distinction only serves to the purpose of defining the duration of corresponding elected positions.} \Comment{agree on definition of major bodies.}
...
\end{center}
\caption{\collabname\ Collaboration Organizational Chart. \textcolor{\markcolor}{To be modified so as to reflect distinction between major and minor bodies, see Sec.2.}}
\label{fig:org_chart}
\end{figure}
...
\item Removal of any Collaboration Member from an elected or appointed leadership role in the event of major failings of professional conduct, or gross insufficiency of performance. \Comment{should we add a reference to the CoC and extend the motivations for removal to non-professional motivations?} Removal requires a supermajority vote of the GB.   Leadership roles include, but are not limited to, the Spokespersons, GB members, \shorte\ members, and Council and Committee members and chairs.  %See also \S\ref{sec:removal}).
...
It is the expectation that GB Members participate in the majority of meetings \textcolor{\markcolor}{($\ge 50\%$). However, individual GB members are allowed to request a reduction of the attendance requirement due to extenuating circumstances (e.g., including but not limited to unfriendly time zones, family leave, parental leave, medical leave). The request can be made to the GB Chair and Vice Chair of the GB. They can determine whether to approve the request and may consult with others if they choose to.} If a GB Member fails to participate %(via meeting attendance or email) 
 \sout{in $\ge 50\%$ of} \textcolor{\markcolor}{in the agreed number} of GB meetings in a year, their seat will be open to election during the following cycle and they will be barred from the board for a two-year term.  
...
The Chair and Vice Chair serve two-year terms that parallel the Collaboration election cycle \textcolor{\markcolor}{and are limited to two consecutive terms with one year off required before standing again.} Membership on the JSAC is open to volunteers from the Collaboration, with the approval of the JSAC Chair, \textcolor{\markcolor}{after solicitation of nominations from the full Collaboration}. \textcolor{\markcolor}{JSAC members serve for two-year terms. Consecutive terms are allowed.} \Comment{Do we need to set a limit to the number of JSAC members?}
...
The Chair and Vice Chair serve two-year terms that parallel the Collaboration election cycle \textcolor{\markcolor}{and are limited to two consecutive terms with one year off required before standing again.} The Chair will appoint additional members as required to ensure adequate knowledge of the collaborations being pursued resides in the ECC. Self nominations for consideration for membership on the ECC are expected \textcolor{\markcolor}{after solicitation of nominations from the full Collaboration}. 
...
The Education and Public Outreach (EPO) Committee is responsible for initiating, overseeing, and recording the Collaboration's efforts in the areas of public outreach and education. Its mission is to disseminate Collaboration results to the public and increase general scientific literacy. The committee is overseen by the \exec \ and members are appointed by the Spokespersons after solicitation of nominations from the full Collaboration and after consultation with the \shorte.
 The Chair is appointed by the Spokespersons after consultation with the \shorte. \textcolor{\markcolor}{and are limited to two consecutive terms with one year off required before standing again.} \sout{Terms on the EPO Committee are for two years, with some initial three-year terms to allow staggered appointments.} \textcolor{\markcolor}{EPO members serve for two-year terms. Consecutive terms are allowed.}  A presentation of EPO efforts and written documentation of activities must be provided to the \shorte\ at each Collaboration meeting or when requested by the \shorte. 
...
The Publication and Speakers Committee will continue to refine the policy, and present a revision no later than March 1, 2020 for ratification by the Voting Members of the Collaboration.  
...
%\sout{Any member invited to give a talk at a conference or workshop must forward that request, upon receipt, to the Speakers Bureau.  The Speakers Bureau will determine whether an alternate person is more appropriate to give the talk considering the contributions of various members to the collaboration, the desire to promote junior members, and the fair distribution of opportunities to give talks.}
...
invitations. %} 
% \textcolor{\markcolor}{ \sout{To give talks not in the above category, a Collaboration member must also notify the Speakers Bureau.}} 
...
Ombudsperson candidates will be self-nominated \textcolor{\markcolor} {after solicitation of nominations from the full Collaboration}.  The Ombudspersons will be selected by the Spokespersons and ratified by the GB.
