...
1.7 & \textcolor{green}{Amendments to Figure 1 and Section 5.2} & & \\ \hline
1.8 & \textcolor{red}{Amendments to Sections 1.2, 5.1, 7, and 7.2 and Figure 1 to redefine Technical Working Groups, preserving the intent of unamended Sections 7.2, 9.2, and 9.3} & & \\ \hline
...
\item \textcolor{magenta}{All Members will be expected to abide by the \collabname\ Code of Conduct.}
...
%\sout{\textcolor{magenta}{Throughout this document, when referring to ``major bodies'', we intend: major body 1, major body 2, .., major body N. Those entities not explicitly mentioned in the former list are intended as ``minor bodies''. Note that this distinction only serves the purpose of defining the duration of corresponding elected positions.} \Comment{agree on definition of major bodies.}}

\begin{figure}[h!]
\begin{center}
\includegraphics[width=6.5in]{cmbs4_org_v11.pdf}
\end{center}
\caption{\collabname\ Collaboration Organizational Chart. \textcolor{green}{EDI is currently an ad hoc committee convened by the Spokespeople.}}%\sout{\textcolor{magenta}{To be modified so as to reflect distinction between major and minor bodies, see Sec.2.}}}
...
\item Formal acceptance of new Collaboration Members, and resolution of membership conflicts/issues, such as the removal of Members from the Collaboration \textcolor{magenta}{for failure to perform their duties or serious violations of the Code of Conduct}. The change in status of a Member (including acceptance or removal) requires approval by a supermajority of the GB.
...
The Chair is appointed by the Spokespersons after consultation with the \shorte  \textcolor{magenta} {and is limited to two consecutive terms with one year off required before standing again.} \textcolor{magenta}{Terms on the EPO Committee are for two years, with some initial three-year terms to allow staggered appointments. Consecutive terms are allowed.}  A presentation of EPO efforts and written documentation of activities must be provided to the \shorte\ at each Collaboration meeting or when requested by the \shorte.   
...
\item {\bf Provisional:} 
New Senior, Postdoctoral and Student Members will normally start with a Provisional status. This is intended to be a temporary status allowing the Provisional Member to demonstrate sufficient constructive engagement with the Collaboration. New members who have already made substantive contributions to CMB-S4 may be deemed to have demonstrated sufficient engagement and be appointed as Full members. Provisional Postdoctoral and Student Members who were designated as members by a Provisional Senior Member may not be raised to Full status before that Senior Member.
...
\item Members have access to computational resources designated for \collabname, according to any policies of the Collabortion and/or Project.

\end{itemize}

\subsection{Membership Requirements}

Members must commit effort to approved infrastructure tasks. The Membership Committee will work with the \exec\ to define and recommend infrastructure tasks that need filling, and to define and communicate with Members the level of expected effort. Tasks can include, for example, designing, building, and testing hardware and software; generating or analysing simulations; developing science requirements and asociated theoretical studies; contributing to commissioning and observations; and management tasks. Just as for the Project hardware and software, we anticipate having Collaboration requirements on the analysis software; members are expected to comply with interface, documentation and code review requirements in support of the goals of the Collaboration. Other ways of contributing include taking on roles in the governance, including membership on the GB, EVC, ET, or the Councils and Committees described in \S\ref{sec:councils}.
...
\item The Annual Activity Reports will be used by the Membership Committee to determine whether to recommend changing any Provisional Member's status to Full or Inactive, or leaving it as Provisional for another year. Such recommendations will then be sent to the Governing Board for its approval.
...
\item \textcolor{magenta}{Procedures that could lead to loss of Membership for strong or persistent violations of the \collabname\ Code of Conduct are described in that document.}
