...
\end{center}
\caption{\collabname\ Collaboration Organizational Chart. \textcolor{green}{EDI is currently an ad hoc committee convened by the Spokespeople.}}
\label{fig:org_chart}
\end{figure}
...
Every year, starting with the inception of the GB, the Chair and Vice Chair of the GB are elected from the GB membership to serve one-year terms. The Secretary of the GB is chosen informally by the GB Chair to serve during their term. 
