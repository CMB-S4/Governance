...
The GB will be composed of 17 members. The Spokespersons and other members of the \exec\ may not serve on the GB.  
...
Spokespersons are elected to two-year terms. \textbf{There are no term limits specified until the Project is established. After the establishment of the Project, term limits of 2 terms are expected to be imposed once CMB-S4 is more established as a project}. The election process is detailed below in Section \ref{sec:elections}. 
...
In a given election year the ordering shall proceed as follows: first elections will be held for co-spokesperson. Next elections will be held (if required by term completion) for Sscience Council chair or deputy chair, chair of the membership council and chair of the publication and speakers council. A third election will be held for Governing Board members. 
Elections for positions outside the top levels of major bodies may occur when required as such officials are not prohibited from serving other elected roles. Each election is managed by the EVC.   The ICCC must establish this committee prior to the formation of the CMB-S4 collaboration. 
