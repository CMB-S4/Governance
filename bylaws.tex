...
1.1 & Amendment to Section 3.4 on Governing Board Meetings & 09/05/2018 & 11/08/2018 \\   & & & \\  \hline % Make the empty  boxes double tall here only to illustrate revisions may come)
& & & \\   & & &\\ \hline
\end{tabular}
\end{center}
\label{tab:version}
