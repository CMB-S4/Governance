...
\maketitle
% * <jtreu@mac.com> 2017-12-19T21:01:00.980Z:
%
% ^.
...
%\Comment{: "cospokespersons" is not capitalized here; yet in the Scope section it is written as "Co-spokespersons" (no hypen and one capital).  Sometimes it's "spokespersons" and sometimes "spokespeople". Let's just decide what it is and be consistent throughout document.  -- Jesse }. 
...
%\Comment { Say: ..., which are discussed in Section 3.6. -- Jesse }
%\textcolor{red}{or presentation of these amendments to collaboration members for approval}
%\Comment{need to discuss: should Amending the By Laws require a super majority?}
%\item Approval of all membership issues, including the admission and removal of members and institutions into the collaboration. Removal of a member requires approval by a super-majority of the GB.
%\item Approval of all membership issues, including the admission and 
...
%\item Participate in and approve of any international negotiations.
\item Organization of elections for Spokespersons, GB members, EB members, and other elected collaboration officials.
%\item Approval of appointments made by the Spokesperson
%\item Ratification of agreements between the external agencies and the collaboration. \Comment{Will need to be amended when there is a host lab}
%\item Establishment and o
...
%\item Ratification of Science Council Members
...
\item Oversight of the activities of the spokespersons. At the request of 3 or more GB members, the GB may require a detailed verbal, or written report from the Spokesperson on any action. %\Comment{Make it more than 1 person in case of conflict between GB member and Spokesperson, if it's important a few people will certainly agree}
\end{itemize}

%
%\textit{Any powers not explicitly assigned to a different governing body in these bylaws reside in the Governing Board}. \Comment{I don't like this statement - Nick} \Comment{ but don't we need a 'default' rule: what happens if we actually miss something -- how do we determine who decides? -- Jesse}
%Already 

\subsection{Board Representation}
The GB will be composed of 19 members. 
%\Comment{I again heard arguments for $10-15$ and $>25$, let's look at how much power this board is given above and decide; if we start small, let's make it scale such that no less than 1 member for each 10 voting member of the collaboration} 
...
%\item \textcolor{red}{Do we want this?}The Spokespersons are authorized to make decisions on behalf of the collaboration if time is of the essence and if both spokespersons are in agreement. Prompt notification of the governing board is required after any such activities.  \textcolor{red}{What if spokespeople don't agree? Suggestion tie breaker chair of GB}  \Comment{maybe if the two Spokespersons don't agree the matter needs to go to a Special Meeting of the GB at which some minimum number of members must participate?}
...
%\Comment{I know we've been through the Co-Spokespersons discussion thoroughly, but this is probably the last opportunity we have to re-consider having two people.  Let's make sure that the other big consortia that have two people at the top actually run well?  To me, having one clear leader is a much better way to organize.   I'd recommend a Spokesperson and a Co-Spokesperson.  This way, the Spokesperson would have a 'thought partner' and someone with whom to share the big load, but the senior responsibility and authority would be clear.  The Co could be the one who becomes Spokesperson when the time comes. -- Jesse}

%\Comment{If we did back away from two Co-Spokespersons, we could elect the Spokesperson for a two year term and a Co-Spokesperson for a two year term, with the Co-Spokesperson ascending to become Spokesperson at the end of their term. This way, there would be a four year involvement for each individual:  two years as Co followed by two years a the Spokesperson. -- Jesse}
...
%Will be subsumed by the ability of the spokesperson to make "ad hoc" committees as well as appoint (with GB approval) several members of the EB. 

%\subsection{Scope and Composition}
%The Technical Council (TC) is another major body established by the Governing board and overseen by the Spokespersons. Prior to the formation of the Project, the TC is charged to coordinate---in consultation with the Spokespeople---the technical aspects needed to meet the scientific objectives of the CMB S4 collaboration. The TC chairs are also members of the Executive Board. 

%The Council is composed of .... %an overall chair and vice-chair elected by the full S4 collaboration as well as the co-leads of the various technical working groups. These working groups are to be formally established by the Spokespeople, %Governing Council, but will likely include groups related to anticipated Level 2 Work Breakdown Structure (WBS) elements of the future Project.    Each working group will have elected co-coordinators who each serve for two year terms, or until the TC is disbanded when the Project begins.   For the first election of leads for a working group the candidate with the highest vote total will serve for a 3 year term to enable staggered elections in the future. More details are provided below in Section \ref{sec:elections}.


%The role of the technical council on this committee will be readdressed in these bylaws when a project is formed.
