...
\ifthenelse{\boolean{markup}}{ {\color{\markcolor} \sout{Figure~2 displays the staggered terms schematically.}} }{} New appointments take office on July 1 in the year of their election.  
...
\textcolor{\markcolor} {A ranked voting scheme approved by the GB prior to the election %\sout{after the collaboration is formed will be} 
...
These members have the same term duration and limits as the elected Chair.} If a MC member leaves before their term is complete,  \textcolor{\markcolor}{the Spokespersons %\sout{\shorte} 
...
\subsection{Spokespersons} 
The IEVC follows the election process \textcolor{\markcolor} {for the Spokespersons}  described in \S\ref{sec:elections} of the Bylaws.  \textcolor{\markcolor}{   %\sout{ Collaboration members may vote for two candidates.} 
