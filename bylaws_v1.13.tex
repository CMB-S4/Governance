...
1.12 & Amendments to Sections 6.1, 6.2, 6.3, and 8.2 clarifying that provisional members cannot run for elected office & 11/22/2024 & TBD \label{tab:version} \\ \hline
1.13 & Amendments to Section 9.3 describing the publication policy for conference proceedings & 11/22/2024 & TBD \label{tab:version} \\ \hline
%& & &\\ \hline
%\end{tabular}
%\end{center}
%\end{table}
