...
\item \textcolor{magenta}{All members will be expected to abide by the \collabname\ Code of Conduct.} \textbf{Comment: This is going to be included in the bylwas as soon as the CoC is in place}
...
\end{center}
\caption{\collabname\ Collaboration Organizational Chart. \textcolor{magenta}{EDI to be added to the chart.}}
\label{fig:org_chart}
\end{figure}
